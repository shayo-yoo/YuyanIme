...
class AppPrefs(private val sharedPreferences: SharedPreferences) {
    ...
    inner class Voice : ManagedPreferenceCategory(R.string.ime_settings_voice, sharedPreferences) {
        val voiceEnabled = switch(R.string.voice_enable, "voice_enable", true)
        val voiceAInteractHold = switch(
            R.string.voice_button_a_hold, "voice_interact_hold_a", false,
            R.string.voice_button_a_hold_tip
        )
        val voiceBInteractHold = switch(
            R.string.voice_button_b_hold, "voice_interact_hold_b", false,
            R.string.voice_button_b_hold_tip
        )
    }
