...
val menuSkbFunsPreset: Map<SkbMenuMode, SkbFunItem> = hashMapOf(
    ...
    SkbMenuMode.Voice to SkbFunItem(Launcher.instance.context.getString(R.string.voice_button_a), R.drawable.ic_menu_mic, SkbMenuMode.Voice),
    SkbMenuMode.VoiceB to SkbFunItem(Launcher.instance.context.getString(R.string.voice_button_b), R.drawable.ic_menu_mic, SkbMenuMode.VoiceB),
